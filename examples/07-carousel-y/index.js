...
export default class Demo extends Component{
  ...
  _getStyle (animate) {
    ...
    console.log(document.body.clientHeight,"HEREHERE")
    return {
      // x : animate
      //   ? spring(current * this.state.screenWidth, presets.stiff)
      //   : (current * this.state.screenWidth),
      y: spring(document.body.clientHeight),
      marginTop:  spring(this.state.open? 1: +window.innerHeight,{stiffness:50, damping:17}),
    ...
    return (
      ...
      >
        ...
        <div
          ...
          <Motion
          defaultStyle={{ marginTop: window.innerHeight }}
            ...
            (config) => {
              return (
                ...
                style= {{
                  ...
                  display:config.marginTop > window.innerHeight ? 'none' : 'block', //config.marginTop < -230 ? 'none' : 'block',
                  // left: -(config.x)
                }}
                >
                  {
