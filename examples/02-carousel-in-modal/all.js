...
*/
var aa=__webpack_require__(0);__webpack_require__(2);var l=__webpack_require__(15),n=__webpack_require__(4),ba=__webpack_require__(16),ca=__webpack_require__(1),da=__webpack_require__(5),ea=__webpack_require__(17),fa=__webpack_require__(18),ha=__webpack_require__(21),ia=__webpack_require__(22);
...
var COLORS = ['#15B371', '#DB3737', '#FF7373', '#F29D49', '#669EFF', '#29A634', '#C274C2', '#30404D', '#9E2B0E', '#A82A2A', '#10161A'];
...
var randomString = function randomString(length) {
  var chars = '01236789abcdefghijkltuvwxyzABNOPQRWXYZ';
  var result = '';
...
var Demo = function (_Component) {
  ...
  function Demo(props) {
    ...
    _this.state = {
      list: [_this._getElement(), _this._getElement(), _this._getElement()],
      current: 0,
      animate: true,
      open: false,
    ...
    _this.getStyle = _this._getStyle.bind(_this);
    _this.getElement = _this._getElement.bind(_this);
    _this.handleKeydown = _this._handleKeydown.bind(_this);
    _this.toggleModal = _this._toggleModal.bind(_this);
  ...
  _createClass(Demo, [{
    ...
    key: '_toggleModal',
    value: function _toggleModal(val) {
      this.setState({
        open: val
      });
    }
    ...
    key: '_getStyle',
    value: function _getStyle(animate) {
      var current = this.state.current;
      return {
        x: animate ? (0, _reactMotion.spring)(current * this.state.screenWidth) : current * this.state.screenWidth
      };
    }
  }, {
    key: '_getElement',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('div', { className: 'modal__modifiers' }),
              _react2.default.createElement(
                _reactMotion.Motion,
                ...
                function (_ref) {
                  ...
                  return _react2.default.createElement(
                    'div',
                    {
                      ...
                      style: {
                        position: 'absolute',
                        width: 5 * _this2.state.screenWidth + 'px',
                        left: -x
                      }
                    },
                    _react2.default.Children.toArray(_this2.state.list)
                  );
                }
              )
            )
...
_reactDom2.default.render(_react2.default.createElement(Demo, null), document.querySelector('#content'));
