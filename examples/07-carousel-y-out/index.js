...
export default class Demo extends Component{
  ...
  _getStyle (animate) {
    ...
    return {
      x : animate ? spring(current * this.state.screenWidth)
        : (current * this.state.screenWidth),
      y: spring(window.innerHeight),
      marginTop:  this.state.closing?
              spring(window.innerHeight,{stiffness:50, damping:17})
              : spring(0),
    }
            ...
            >
              <div className="modal__modifiers">
                <div
                  ...
                  onClick = { () => this.setState({closing:true})/*this.toggleModal(false)*/ }
                >
                  X
                </div>
                <div
                ...
                >
                  <div
                    ...
                    onClick={(e)=>{this.handleKeydown({keyCode: 37})}}
                    style={{
                  ...
                  <div
                    ...
                    onClick={(e)=>{this.handleKeydown({keyCode: 39})}}
                    style={{
              ...
              <Motion
                defaultStyle={{
                   marginTop: this.state.closing ? 0 : window.innerHeight,
                   x:0,
                   y:0,
                   }}
                ...
                ({x,y,marginTop}) => {
                  return (
                    ...
                    style= {{
                      ...
                      height:'100%',
                      marginTop: marginTop,
                      display: marginTop > window.innerHeight ? 'none' : 'block',
                       left: -(x||0)
                    }}
                    >
                      {
